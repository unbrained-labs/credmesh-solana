...
pub mod program_ids {
    ...
    pub const REPUTATION: Pubkey = pubkey!("JDBeDr9WFhepcz4C2JeGSsMN2KLW4C1aQdNLS2jvc79G");
    pub const RECEIVABLE_ORACLE: Pubkey = pubkey!("ALVf6iyB6P5RFizRtxorJ3pAcc4731VziAn67sW6brvk");
